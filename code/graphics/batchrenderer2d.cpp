...
void BatchRenderer2D::submit(const Renderable2D *renderable)
{
    ...
    // Should this really be set in else case?
    // This should be default color -> always set, such that it is possible to see when
    // texture loading fails in shader...
    // TODO(klek): Verify this!!
//    else
//    {
